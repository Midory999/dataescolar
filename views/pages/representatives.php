...
<section>
	...
	<a class="w3-button w3-pink w3-round-medium" href="<?= $root ?>/representantes/registrar">Añadir representante</a>
			...
			<tbody>
				...
				<tr>
				  <td>{$representative->idCard}</td>
					...
					<td>{$representative->getGender()}</td>
					...
					<td>{$representative->getStudies()}</td>
				</tr>
				HTML ?>
			</tbody>
		</table>
